...
wss.on("connection", (ws) => {
  ...
  ws.on("message", (buf) => {
    ...
    if(type === "move_commit"){
      ...
      // if no barricade handling is pending, end turn
      // (client will send picked_barricade + place_barricade if needed)
      // We advance turn here optimistically; if client later picks barricade it will still place and advance again.
      // To keep it stable: only advance now if dest is NOT a barricade currently.
